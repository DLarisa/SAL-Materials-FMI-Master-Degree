...
CREATE OR REPLACE PROCEDURE P_criptare(text IN VARCHAR2, cheie IN raw, text_criptat OUT VARCHAR2)
AS
    raw_sir RAW(100);
    raw_parola RAW(100);
    rezultat RAW(100);
...
FOR EACH ROW
declare
    cheie_criptare_email raw(16):= dbms_crypto.randombytes(16);
    cheie_criptare_password raw(16) :=  dbms_crypto.randombytes(16);  
...
insert into credential(id, email, password, employee_id) values (19,'employee@gmail.com','employee_password',2);
